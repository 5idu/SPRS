...
export default class FPQueryByDescriptionBody extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false
    ...
    search = () => {
        ...
        let desc = this.refs.textField.input.value
        this.props.history.push(`/fpquery/desc/${desc}`);
    }
